...
public class PhaseDeplacement implements PhaseJeu{
    ...
    public PhaseDeplacement(ConsoleReader lecteur) {
    ...
    public void executer(Carte carte, Joueur joueur) {
        ...
        if (!verifierConditions(pFrom, pTo, nb, joueur)) return;
    ...
    private boolean verifierConditions(Pays pFrom, Pays pTo, int nb, Joueur joueur) {
